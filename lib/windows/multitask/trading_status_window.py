...
class MultitaskWindow(QWidget):
    ...
    toggle_log_signal = pyqtSignal()  # Signal to toggle the log window
    ...
    def __init__(self, theme="dark", parent=None):
        ...
        self.layout.setContentsMargins(0, 0, 0, 0)  # Уменьшены отступы для всего окна
        self.layout.setSpacing(0)  # Уменьшено расстояние между элементами
        ...
        self.settings_button = QPushButton("НАСТРОЙКИ")  # Add settings button
        ...
        # Создаем контейнеры для каждой кнопки с фиксированным весом
    ...
    def update_strategy(self, strategy):
        """Update the current strategy and refresh settings view if needed"""
        self.strategy = strategy
        # Reload settings view if it's currently visible
